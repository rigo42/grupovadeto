    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
                    ...
                    <div class="mt-1">
                        ...
                        <div class="image-input image-input-outline">
                            ...
                            <div 
                                ...
                                @else
                                    style="background-image: url('{{ $brand->imagePreview() }}')"
                                @endif
                            ></div>
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" required wire:model.defer="brand.name" class="form-control form-control-solid @error('brand.name') 'invalid-feedback' @enderror" placeholder="Nombre de la marca" name="" />
                @error('brand.name') <small  class="form-text text-danger" role="alert">{{ $message }}</small> @enderror
            </div>
            <!--end::Input group-->
            <!--begin::Actions-->
