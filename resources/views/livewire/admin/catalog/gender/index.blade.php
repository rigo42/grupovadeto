    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                @include('admin.catalog.gender.create')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-125px">Género</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        ...
                        <tr>
                            <td>{{ $gender->name }}</td>
                            <td>{{ count($gender->products) }}</td>
                            <td>
                               {{ $gender->dateToString() }}
                            </td>
                            <!--begin::Action=-->
                            <td class="">
                                @include('admin.catalog.gender.edit')
                                @include('admin.catalog.gender.delete')
                            </td>
                            <!--end::Action=-->
                        </tr>
                        <!--end::Table row-->
